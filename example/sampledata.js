...
const sampleUsers = [
    ...
    { email: 'testuser6@b3fl.com', username: 'user6' },
    { email: 'testuser7@b3fl.com', username: 'user7' },
    { email: 'testuser8@b3fl.com', username: 'user8' },
    { email: 'testuser9@b3fl.com', username: 'user9' },
...
createSurvivorPoolEntry.run('dummy.user.test@com.com', 6, '866400340310917120', USERS.find(user => user.sleeperId_current == '866400340310917120').name, new Date().toISOString());
